...
function Deck( container, callback ){
			...
			if ( target.tagName == "A" && target.href ){
				...
				if ( id ){
					...
					if ( key ){
						...
						if ( card.names && ( card.layout == "meld" || card.layout == "transform" || card.layout == "flip" || card.layout == "modal_dfc" ) ){
	...
	this.load = function load( bundle ){
		...
		var selection = ( !bundle.format || bundle.format == "default" ) ? "" : bundle.format;
